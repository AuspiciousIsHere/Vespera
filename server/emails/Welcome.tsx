...
export default function Welcome({ firstName, url }: WelcomeProps) {
  return (
    <Html>
      <Head />
      <Body className="bg-white font-koala">
        ...
        <Container className="mx-auto py-5 pb-12">
          <Text className="text-[16px] leading-[26px]">Hi {firstName},</Text>
          ...
          <Section className="text-center">
            <Button className="bg-[#5F51E8] rounded-[3px] text-white text-[16px] no-underline text-center block p-3" href="https://getkoala.com">
              Get started
            </Button>
          </Section>
          <Text className="text-[16px] leading-[26px]">
