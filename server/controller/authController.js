...
import { sendResetPasswordEmail, sendWelcomeEmail } from "../utils/sendEmail.ts";
...
export const login = catchAsync(async (req, res, next) => {
  ...
  await sendWelcomeEmail(user, "localhost:5173");
...
export const resetPasswrod = catchAsync(async (req, res, next) => {
  ...
  console.log("test user", Date.now());
  console.log("test user reset expire", new Date(testUser.passwordResetExpires).getTime());
  console.log("test user reset expire", testUser.passwordResetExpires);
